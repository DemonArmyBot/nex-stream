...
router.get('/api/content/library', async (req, res) => {
  try {
...
router.post('/api/content/upload', verifyAdmin, async (req, res) => {
  try {
...
router.put('/api/content/:id', verifyAdmin, async (req, res) => {
  try {
    const { id } = req.params;
